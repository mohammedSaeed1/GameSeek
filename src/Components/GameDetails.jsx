...
export default function GameDetails() {
  ...
  axios.get(`https://corsproxy.io/?https://www.freetogame.com/api/game?id=${id}`)
    .then((response) => {
    ...
    <section className="sm:w-[85%] mx-auto py-10">
      ...
      <div className="sm:flex items-start justify-between gap-7 mb-10">
        ...
        <div className="details w-2/3 text-white mx-auto">
          ...
          <p className="text-gray-300 leading-relaxed mb-5">{gameDetails?.description}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="bg-[#0f0f1e] p-5 rounded-lg border border-[#2a2a3e] hover:border-blue-500 transition-all">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="text-gray-400 text-sm font-semibold uppercase">Operating System</h4>
              </div>
              <p className="text-white text-lg font-semibold">{gameDetails?.minimum_system_requirements?.os}</p>
            </div>
            ...
            <div className="bg-[#0f0f1e] p-5 rounded-lg border border-[#2a2a3e] hover:border-green-500 transition-all">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="text-gray-400 text-sm font-semibold uppercase">Processor</h4>
              </div>
              <p className="text-white text-lg font-semibold">{gameDetails?.minimum_system_requirements?.processor}</p>
            </div>
            ...
            <div className="bg-[#0f0f1e] p-5 rounded-lg border border-[#2a2a3e] hover:border-purple-500 transition-all">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="text-gray-400 text-sm font-semibold uppercase">Memory (RAM)</h4>
              </div>
              <p className="text-white text-lg font-semibold">{gameDetails?.minimum_system_requirements?.memory}</p>
            </div>
            ...
            <div className="bg-[#0f0f1e] p-5 rounded-lg border border-[#2a2a3e] hover:border-red-500 transition-all">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="text-gray-400 text-sm font-semibold uppercase">Graphics Card</h4>
              </div>
              <p className="text-white text-lg font-semibold">{gameDetails?.minimum_system_requirements?.graphics}</p>
            </div>
            ...
            <div className="bg-[#0f0f1e] p-5 rounded-lg border border-[#2a2a3e] hover:border-yellow-500 transition-all md:col-span-2">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="text-gray-400 text-sm font-semibold uppercase">Storage Space</h4>
              </div>
              <p className="text-white text-lg font-semibold">{gameDetails?.minimum_system_requirements?.storage}</p>
            </div>
          </div>
        </div>
      )}
